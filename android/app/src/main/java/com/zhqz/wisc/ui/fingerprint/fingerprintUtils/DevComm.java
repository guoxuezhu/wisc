...
// public static final int     CMD_GET_COMMNAD_VALID_FLAG_CODE			     = (0x013D);
    ...
    public int DevComm_Init(Activity parentActivity, IUsbConnState usbConnState) {
        m_nConnected = 0;
        m_nUARTReadLen = 0;
        return 0;
    }
    ...
    public void SetCmdData(short p_wData, boolean p_bFirst) {
        if (p_bFirst) {
            ...
            ELog.e("==tjj==m_abyPacket=="+m_abyPacket[6]);
            ELog.e("==tjj==m_abyPacket=="+m_abyPacket[7]);
        } else {
...
//    	if ( g_pPacketBuffer->wCMD_RCM != CMD_FP_CANCEL_CODE )
    ...
    public boolean USB_ReceiveAck(short p_wCmd) {
        ...
        if (p_wCmd == CMD_VERIFY_CODE || p_wCmd == CMD_IDENTIFY_CODE || p_wCmd == CMD_IDENTIFY_FREE_CODE ||
                p_wCmd == CMD_ENROLL_CODE || p_wCmd == CMD_ENROLL_ONETIME_CODE)
        ...
        do {
            ...
            //ELog.i("========StartSendThread========do=====while===1111111==");
            if (!m_usbBase.UsbSCSIRead(btCDB, 8, m_abyPacket, w_nLen, w_dwTimeOut)){
                ELog.i("========StartSendThread========do=====while===222222222==");
                return false;
            }
    ...
    public boolean USB_ReceiveAck2(short p_wCmd) {
        ...
        do {
            ...
            if (!m_usbBase.UsbSCSIRead(btCDB, 8, m_abyPacket2, w_nLen, w_dwTimeOut)){
                ELog.i("========StartSendThread========do=====while===22222222222222==");
                return false;
            }
            SystemClock.sleep(COMM_SLEEP_TIME);
...
//    			return false;
    ...
    public boolean memcmp(byte[] p1, byte[] p2, int nLen) {
       ...
       // ELog.i("============do=====while===33333333333333==");
        return true;
    }
