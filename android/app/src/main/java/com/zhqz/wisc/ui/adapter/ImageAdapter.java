...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
    ...
    public ImageAdapter(Context context, List<ZuoPin> zuoPin, CallBack cb) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (zuoPin.fileType.equals("JPEG")||zuoPin.fileType.equals("PNG")) {
            Glide.with(WiscApplication.context).load(zuoPin.filePath)
    ...
    public interface CallBack {
        void onZuopinVideoItemClicked(int position);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void onItemClicked() {
            if (mCallback != null && item != null) {
                mCallback.onZuopinVideoItemClicked(getPosition());
