...
public class KeChengAdapter extends BaseAdapter {
    ...
    Context context;
    List<Courses.Today> todayList;

    public KeChengAdapter(Context context, List<Courses.Today> todays) {
        this.context = context;
        this.todayList = todays;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Courses.Today mcourses= todayList.get(position);
