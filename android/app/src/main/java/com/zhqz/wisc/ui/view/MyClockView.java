...
public class MyClockView extends View {
    ...
    //刻度线宽度
    private final static int MARK_WIDTH = 2;

    //刻度线长度
    private final static int MARK_LENGTH = 5;

    //刻度线与圆的距离
    private final static int MARK_GAP = 8;

    //时针宽度
    private final static int HOUR_LINE_WIDTH = 4;

    //时针宽度
    private final static int MINUTE_LINE_WIDTH = 4;
    ...
    //获取时间监听
    private com.don.clockviewlibrary.ClockView.OnCurrentTimeListener onCurrentTimeListener;

    public void setOnCurrentTimeListener(com.don.clockviewlibrary.ClockView.OnCurrentTimeListener onCurrentTimeListener) {
    ...
    public MyClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, com.don.clockviewlibrary.R.styleable.ClockView);
        mCircleColor = a.getColor(com.don.clockviewlibrary.R.styleable.ClockView_circle_color, Color.WHITE);
        mHourColor = a.getColor(com.don.clockviewlibrary.R.styleable.ClockView_hour_color, Color.BLACK);
        mMinuteColor = a.getColor(com.don.clockviewlibrary.R.styleable.ClockView_minute_color, Color.BLACK);
        mSecondColor = a.getColor(com.don.clockviewlibrary.R.styleable.ClockView_second_color, Color.RED);
        mQuarterMarkColor = a.getColor(com.don.clockviewlibrary.R.styleable.ClockView_quarter_mark_color, Color.parseColor("#B5B5B5"));
        mMinuteMarkColor = a.getColor(com.don.clockviewlibrary.R.styleable.ClockView_minute_mark_color, Color.parseColor("#EBEBEB"));
        isDrawCenterCircle = a.getBoolean(com.don.clockviewlibrary.R.styleable.ClockView_draw_center_circle, false);
        a.recycle();
        init();
    }
