...
public class MqttManager {
    ...
    public boolean creatConnect(String brokerUrl, String userName, String password, String clientId) {
        ...
        try {
            ...
            ELog.i("=====MqttException==" + e.getMessage());
        }
    ...
    public boolean publish(String topicName, int qos, byte[] payload) {
        ...
        if (client != null && client.isConnected()) {
            ...
            ELog.i("=publish====" + "Publishing to topic \"" + topicName + "\" qos " + qos);
    ...
    public boolean subscribe(String topicName, int qos) {
        ...
        if (client != null && client.isConnected()) {
            ...
            ELog.i("=subscribe==1==" + "Subscribing to topic \"" + topicName + "\" qos " + qos);
            try {
                client.subscribe(topicName, qos);
                flag = true;
                ELog.i("=subscribe==2==" + "Subscribing to topic \"" + topicName + "\" qos " + qos);
