...
//    FingerprintPresenter mFingerprintPresenter;
//
//    public SZOEMHost_Lib(Activity parentActivity, TextView p_pStatusView, ImageView p_FpImageViewer,
//                         Runnable p_runEnableCtrl, FingerprintPresenter fingerprintPresenter) {
//        m_bThreadWork = false;
//        if (m_devComm == null) {
...
//    }
//
//    public int SZOEMHost_Lib_Init(Activity parentActivity, TextView p_pStatusView, ImageView p_FpImageViewer,
//                                  Runnable p_runEnableCtrl, FingerprintPresenter fingerprintPresenter) {
//        m_bThreadWork = false;
//
//        if (m_devComm == null) {
...
//    }
//
//    public int writeTemplate(int p_nTmpNo, String dataString) {
//
//        new Thread(new Runnable() {
//            @Override
//            public void run() {
//                Run_CmdWriteTemplate(p_nTmpNo, dataString);
//            }
//        }).start();
//        return 0;
//    }
...
////        }
//
//        String[] xxxx = dataString.split(",");
//        int length = xxxx == null ? 0 : xxxx.length;
//        byte[] k = new byte[length];
//        for (int j = 0; j < length; j++) {
//            k[j] = Integer.valueOf(xxxx[j]).byteValue();
//        }
//
//        m_TemplateData = k;
//        m_nTemplateSize = 570;
...
//                            break;
//                        } else {
//                            System.arraycopy(m_devComm.m_abyPacket, 8, m_TemplateData, w_nBufOffset, m_devComm.GetDataLen() - 2);
...
//                    }
//                    // ELog.i("==============111111111=========="+str);
//                    mFingerprintPresenter.sendZhiwenData(str);
//
//                    String strss = new String(m_TemplateData, Charset.forName("ISO_8859_1"));
//                    // mFingerprintPresenter.sendZhiwenData(strss);
//
//                    //ELog.i("========================"+strss);
//
//                    byte[] xxxx = strss.getBytes(Charset.forName("ISO_8859_1"));
//                    //ELog.i("========================"+xxxx);
//
//                    String strsss = "";
//                    for (int ii = 0; ii < xxxx.length; ii++) {
//                        strsss += xxxx[ii] + ",";
//                    }
//
//
...
//                            m_strPost = String.format("Result : Success\r\nTemplate No : %d", w_nData);
//                            ELog.i("===输入你的手指==Success====");
//                            mFingerprintPresenter.showMessage(1);
//                            break;
//                    }
//                } else {
//                    m_strPost = String.format("Result : Fail\r\n");
...
//                if (w_nRet == (short) DevComm.ERR_SUCCESS) {
//                    m_strPost = String.format("Result : Success");
//                    WriteTemplateFile(0, m_TemplateData);
//                } else {
//                    m_strPost = String.format("Result : Fail\r\n");
//                    m_strPost += GetErrorMsg(w_nData);
//                }
